<template>
    <section class="font-sans py-8 px-8 lg:py-24 lg:px-24 bg-gray-900">
        <div class="wrapper">
            <div class="box">
                <div></div>
                <div></div>
        ...
        <div class="flex items-center">
            <div class="md:w-1/2">
                ...
                <h1 class="mt-2 text-2xl lg:text-4xl text-indigo-600 font-black transform hover:-translate-y-1">
                    Motasim Emad
                </h1>   
                ...
                <div class="flex items-center mt-6">
                    <a class="bg-gray-800 py-2 px-4 lg:py-4 lg:px-8 font-semibold rounded-lg flex items-center text-white hover:bg-gray-700 hover:text-gray-200" href="https://drive.google.com/file/d/1PXG6BoaXUYXgGfllRXXQ9stl_VY0Dr-z/view?usp=sharing" download>
